...
slides:
  ...
  - cover: /img/jij-groen.png  
    ...
    details:
      ...
      wish: |         
        Participatieflatform
      solution: |
        In een agile proces een user-centric platform ontworpen. Mobile first designs en Sass and Bootstrap gebaseerd CSS-framework ontwikkeld
      task: |
        Design aanbestedingstraject presentatie, interaction design, web design, front-end development, graphic design 
  ...
  - cover: /img/mvrdv.png
    ...
    body: |
      ...
      Nu is MVRDV klaar voor de volgende stap. Op dit moment loopt een conceptfase. Hierin heb ik onderzoek gedaan voor een nieuwe online branding en beleving.
---