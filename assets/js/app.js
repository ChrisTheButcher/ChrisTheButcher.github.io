...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AsyncMedia = __webpack_require__(7);
	...
	new _AsyncMedia.AsyncMedia("img, video, [style*='background-image']");
	...
	function updateTheme() {
	  var themeInverted = inverted.map(function (x) {
	    return (0, _DomHelper.inView)(x, 40);
	  }).indexOf(true) > -1;
	...
	window.getInstagram = function () {
	  ...
	  var element = document.querySelector('.instagram');
	  var imagesTemplate = "";
	  (0, _DomHelper.json)(url).then(function (data) {
	    data.data.forEach(function (post) {
	      var img = post.images.standard_resolution.url;
	      var time = (0, _moment2.default)(post.created_time * 1000).format("MM/DD/YYYY");
	    ...
	    new _AsyncMedia.AsyncMedia(".instagram a");
	  });
	};
...
/***/ (function(module, exports) {
	...
	function toggleClass() {
	    ...
	    try {
	        var _loop = function _loop() {
	            ...
	            $select(key).forEach(function (el) {
	...
	var ToggleClass = exports.ToggleClass = function ToggleClass() {
	    ...
	    $select('[data-toggle-class]').forEach(function (el) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.AsyncMedia = undefined;

	var _DomHelper = __webpack_require__(1);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var AsyncMedia = exports.AsyncMedia = function AsyncMedia(selector) {
	    _classCallCheck(this, AsyncMedia);

	    (0, _DomHelper.$select)(selector).forEach(function (e) {
	        var saved = void 0,
	            img = void 0;
	        ...
	        if (e.matches("[style*='background-image']")) {
	            ...
	            e.src = "";
	            img = e;
	            e.tagName === "VIDEO" ? setTimeout(function () {
	                return e.src = saved;
	            }) : setTimeout(function () {
	                return e.src = saved;
	            }, 3000);
